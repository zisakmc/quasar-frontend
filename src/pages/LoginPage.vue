<template>
  <div rounded class="flex justify-center items-center q-mt-lg">
      ...
      <div class="q-pa-md flex justify-start">
        <div class="flex justify-center items-center">
          <img
            ...
            style="max-width: 300px" class="gt-sm" />
        </div>
        <q-form class="item-center q-pa-md col">
          <q-label class="q-mb-md">Email</q-label>
          <q-input class="q-mb-md q-mt-md" outlined v-model="email" type="email" label="email" />
          <q-label class="q-mt-md">Password</q-label>
          <q-input class="q-mt-md" outlined v-model="password" filled label="password"
            :type="ispwd ? 'password' : 'text'">
            <template v-slot:append>
              <q-icon :name="ispwd ? 'visibility_off' : 'visibility'" class="pointer-cursor" @click="ispwd = !ispwd" />
            </template>
          </q-input>
